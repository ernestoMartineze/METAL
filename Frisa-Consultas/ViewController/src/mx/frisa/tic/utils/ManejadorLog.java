...
public class ManejadorLog {
    ...
    private static void init() throws MalformedURLException {       
        ...
        String file = new File("/tmp/frisa/portal/log4j.properties").toURI().toURL().toString();
        //String file = new File("C:\\tmp\\frisaPortal\\log4j.properties").toURI().toURL().toString();
