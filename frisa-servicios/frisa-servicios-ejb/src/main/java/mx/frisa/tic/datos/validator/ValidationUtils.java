...
public class ValidationUtils {
    ...
    public static boolean isJsonValid(JsonSchema jsonSchemaNode, JsonNode jsonNode) throws ProcessingException {
        ...
        validateJson(jsonSchemaNode,jsonNode);
        ProcessingReport report = jsonSchemaNode.validate(jsonNode);
    ...
    public static void main(String[] args) throws IOException {
        File schemaFile = new File("C:\\tmp\\frisa\\jsVal\\validaEsquema_Facturas.json");
        File jsonFile = new File("C:\\tmp\\frisa\\jsVal\\FacturaCabeceraLinea.json");
